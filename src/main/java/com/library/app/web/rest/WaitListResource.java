...
/**
 * REST controller for managing {@link com.library.app.domain.WaitList}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class WaitListResource {
    ...
    public WaitListResource(WaitListRepository waitListRepository) {
    ...
    public ResponseEntity<WaitList> updateWaitList(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, waitList.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<WaitList> partialUpdateWaitList(
        ...
        Optional<WaitList> result = waitListRepository
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, waitList.getId().toString())
        );
    }
