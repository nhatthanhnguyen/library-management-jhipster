...
/**
 * REST controller for managing {@link com.library.app.domain.BookCopy}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class BookCopyResource {
    ...
    public ResponseEntity<BookCopy> updateBookCopy(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, bookCopy.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<BookCopy> partialUpdateBookCopy(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody BookCopy bookCopy
    ) throws URISyntaxException {
        ...
        Optional<BookCopy> result = bookCopyRepository
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, bookCopy.getId().toString())
        );
    }
