    ...
    <div>
      ...
      <div className="table-responsive">
        {checkoutList && checkoutList.length > 0 ? (
            ...
            <tbody>
              {checkoutList.map((checkout, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    {checkout.startTime ? <TextFormat type="date" value={checkout.startTime} format={APP_LOCAL_DATE_FORMAT} /> : null}
                  </td>
          ...
          !loading && <div className="alert alert-warning">No Checkouts found</div>
        )}
      </div>
      {totalItems ? (
