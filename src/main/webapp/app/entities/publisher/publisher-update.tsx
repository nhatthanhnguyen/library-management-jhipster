  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="libraryManagementApp.publisher.home.createOrEditLabel" data-cy="PublisherCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              {!isNew ? <ValidatedField name="id" required readOnly id="publisher-id" label="ID" validate={{ required: true }} /> : null}
              <ValidatedField
                label="Name"
                id="publisher-name"
                name="name"
