...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './hold.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HOLD_LIST actions', async () => {
    ...
    it('dispatches FETCH_HOLD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_HOLD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_HOLD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_HOLD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_HOLD actions', async () => {
      const expectedActions = [
        {
